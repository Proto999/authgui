...
"border-radius: 5px;")
        ...
        self.gridLayout.addItem(self.verticalSpacer_2, 4, 3, 1, 1)
...
"border-radius: 20px;")
        ...
        self.textEdit.setMinimumSize(QSize(800, 40))
        self.textEdit.setFont(font1)
        self.textEdit.setStyleSheet(u"background-color: rgb(135, 135, 135);\n"
"color: rgb(38, 38, 38);")
...
"color: rgb(38, 38, 38);")
        ...
        self.gridLayout.addItem(self.verticalSpacer_6, 2, 3, 1, 1)
