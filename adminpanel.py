...
class Ui_AdminPanelWidget(object):
    def setupUi(self, AdminPanelWidget):
        if not AdminPanelWidget.objectName():
            AdminPanelWidget.setObjectName(u"AdminPanelWidget")
        AdminPanelWidget.resize(1000, 700)
        font = QFont()
        font.setFamilies([u"gg sans"])
        font.setPointSize(10)
        AdminPanelWidget.setFont(font)
        AdminPanelWidget.setStyleSheet(u"background-color: rgb(83, 83, 92);")
        self.gridLayout_3 = QGridLayout(AdminPanelWidget)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.verticalSpacer_7 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_3.addItem(self.verticalSpacer_7, 2, 1, 1, 1)

        self.verticalSpacer_6 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_3.addItem(self.verticalSpacer_6, 0, 1, 1, 1)

        self.groupBox_3 = QGroupBox(AdminPanelWidget)
...
"border-radius: 5px;")
        ...
        self.groupBox_2 = QGroupBox(AdminPanelWidget)
...
"border-radius: 5px;")
        ...
        self.gridLayout_3.addItem(self.horizontalSpacer_16, 1, 0, 1, 1)

        self.verticalSpacer_5 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_3.addItem(self.verticalSpacer_5, 4, 1, 1, 1)

        self.groupBox = QGroupBox(AdminPanelWidget)
...
"color: rgb(38, 38, 38);")
        ...
        self.gridLayout_3.addWidget(self.groupBox, 0, 3, 5, 1)

        self.horizontalSpacer_17 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_3.addItem(self.horizontalSpacer_17, 1, 4, 1, 1)
        ...
        self.retranslateUi(AdminPanelWidget)

        QMetaObject.connectSlotsByName(AdminPanelWidget)
    # setupUi

    def retranslateUi(self, AdminPanelWidget):
        AdminPanelWidget.setWindowTitle(QCoreApplication.translate("AdminPanelWidget", u"\u041f\u0430\u043d\u0435\u043b\u044c \u0430\u0434\u043c\u0438\u043d\u0438\u0441\u0442\u0440\u0430\u0442\u043e\u0440\u0430", None))
        self.groupBox_3.setTitle("")
        self.pushButton_2.setText(QCoreApplication.translate("AdminPanelWidget", u"\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f", None))
        self.label_2.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u043f\u0440\u0430\u0432 \u0434\u043e\u0441\u0442\u0443\u043f\u0430 \u043a \u0444\u0430\u0439\u043b\u0430\u043c", None))
        self.label_4.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f:", None))
        self.label_6.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0444\u0430\u0439\u043b:", None))
        self.groupBox_2.setTitle("")
        self.comboBox_2.setItemText(0, QCoreApplication.translate("AdminPanelWidget", u"\u041c\u043e\u0434\u0435\u0440\u0430\u0442\u043e\u0440", None))
        self.comboBox_2.setItemText(1, QCoreApplication.translate("AdminPanelWidget", u"\u041f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c", None))
        self.comboBox_2.setItemText(2, QCoreApplication.translate("AdminPanelWidget", u"\u0413\u043e\u0441\u0442\u044c", None))

        self.label_3.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f:", None))
        self.label.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u0440\u043e\u043b\u0438 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f", None))
        self.pushButton.setText(QCoreApplication.translate("AdminPanelWidget", u"\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f", None))
        self.label_5.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0440\u043e\u043b\u044c:", None))
        self.groupBox.setTitle("")
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("AdminPanelWidget", u"\u041f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0438", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("AdminPanelWidget", u"\u0420\u043e\u043b\u0438", None));
    # retranslateUi
